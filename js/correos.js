...
PuntosCorreos.prototype = {
    ...
    getPuntosCorreos:function(method)
    {
        ...
        this.correosMethod = method;
        this.showWaitLoader();
        //Omitsis:Els métodes del onestep carreguen les dades a la part de la informació de l'enviament
        ...
        new Ajax.Request(this.reloadurl, {
            ...
            //Omitsis: Els mètodes del onestep carreguen les dades a la part de la informació de l'enviament
            //També s'ha afegit el onFailure
            onComplete: //this.reloadMethod.bind(this)
                function(transport){
    ...
    correosInfo:function()
    {
        ...
        this.correosResultados.oficinas.each(  
            function(e) { 
                ...
                {
                    //Omitsis - sense la funció "update_shipping_info" no arriba la ciutat de l'oficina correctament a la shipping address
